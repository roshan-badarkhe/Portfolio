...
const Contact = () => {
  return (
    <section class=" dark:bg-slate-800">
      <div class="pb-8 pt-4 lg:pb-16 px-4 mx-auto max-w-screen-md">
        <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">
          Contact Me
        </h2>
        <p class="mb-8 lg:mb-12 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">
          Want to connect? Fill in your details, I'll get back to you soon
        </p>
        <form action="#" class="space-y-8">
          ...
          <div class="sm:col-span-2">
            ...
            <textarea
              id="message"
              rows="6"
              class="block p-2 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
